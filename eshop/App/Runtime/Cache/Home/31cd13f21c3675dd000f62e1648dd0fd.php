            ...
            <tbody>
                <?php if(empty($list)): ?><tr>
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td>
                        <span><?php echo ($item["goodnumber"]); ?></span></td>
                      <td><span style="color:red;">
                        <?php if(empty($$item["ilegal_reason"])): ?>违规缘由暂不清楚！！！
                        </else>
                        <?php echo ($item["ilegal_reason"]); endif; ?>
                      </span>
                    </td>
                      <td><span><?php echo (date("y-m-d H:i",$item["modify_recenet"])); ?></span></td>
                      <td>
