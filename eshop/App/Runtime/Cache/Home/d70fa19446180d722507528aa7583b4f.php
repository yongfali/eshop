<?php if (!defined('THINK_PATH')) exit();?><!-- 商品列表ajax分页 -->
  ...
  <tbody>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td>
          ...
          <a href="javascript:delGoods(0,<?php echo ($item["id"]); ?>)" class="good_del">删除</a> <a href="javascript:goodEdit(<?php echo ($item["id"]); ?>)" class="good_edit">编辑</a></td>
