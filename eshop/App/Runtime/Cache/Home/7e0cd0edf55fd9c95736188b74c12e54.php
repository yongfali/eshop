...
<script src="/eshop/Public/Home/Js/Cart/ShoppingCart.js"></script>
<script type="text/javascript">
...
<div class="shopcart_wrapper">
  ...
  <div class="cart_title">我的购物车<span>（
    ...
    ）</span></div>
  <!-- 标题 -->
  <?php if(empty($cart)): ?><div class="cart-info-wrap">
      <div class="cart-info-img">
        <img src="/eshop/Public/Home/Icon/empty-cart.png">
      </div>
      <div class="cart-info">
        <span>您的购物车还是空的，<a href="<?php echo U('Home/Index/index');?>">赶紧去逛逛 ~ ~ ~</a></span>
      </div>
    </div>
    <?php else: ?>
    <div class="cart_content">
        <table class="cart_lists">
          ...
          <tbody>
            <?php if(is_array($cart)): $i = 0; $__LIST__ = $cart;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i; if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i; if($item['goodid'] == $data['goodid']): ?><tr class="shop_info">
                    <td colspan="6"> 店铺：&nbsp;<a href="<?php echo U('Home/Shop/index',array('shopId'=> $data['id']));?>" target="_blank"><?php echo ($data["shopname"]); ?></a> &nbsp;&nbsp;&nbsp;商家：&nbsp;<a href="<?php echo U('Home/Shop/index',array('shopId'=> $data['id']));?>" target="_blank"><?php echo ($data["shopername"]); ?></a> <a href="tencent://message/?uin=<?php echo ($data["service_qq"]); ?>&Site=qq&Menu=yes"s><img src="/eshop/Public/Home/ShopImage/qq.gif"></a></td>
                  </tr><?php endif; endforeach; endif; else: echo "" ;endif; ?>
              <tr class="cart_tr">
                <td class="items cart_td1">
                  <input type="checkbox" class="goods_check" autocomplete="off"/>
                  <input type="hidden" goodId="<?php echo ($item['goodid']); ?>" class="goodId"/>
                </td>
                <td class="items2 cart_td2">
                  <a href="<?php echo U('Home/Index/goodsInfo',array('id'=>$item['goodid']));?>" target="_blank"><img src="/eshop/<?php echo ($item["good_log"]); ?>"/>
                  </a>
                  <span class="goodName"><?php echo ($item["name"]); ?></span>
                </td>
                <td class="items cart_td3"><?php echo ($item["shopprice"]); ?></td>
                <td class="items cart_td4"><a href="javascript:void(0)" class="jian" onclick="changeCartNum(this,<?php echo ($item["goodid"]); ?>,<?php echo ($type); ?>,'jian')">-</a>
                  <input class="goodnum" value="<?php echo ($item["mount"]); ?>" name="num[]" type="text" autocomplete="off">
                  <a href="javascript:void(0)" class="jia" onclick="changeCartNum(this,<?php echo ($item["goodid"]); ?>,<?php echo ($type); ?>,'jia')">+</a></td>
                <td class="items cart_td5"><?php echo getCartItemPrice($item['goodid'],$cart);?></td>
                <td class="items cart_td6">
                  <a href="javascript:void(0)" onclick ="delCarts(<?php echo ($item["goodid"]); ?>,<?php echo ($type); ?>)">删除</a>
                </td>
        ...
        <div class="sumMoney"> 
          ...
          <a href="javascript:void(0)" onclick="toSettlement(<?php echo ($type); ?>)">结算</a> 
         <!-- <a href="<?php echo U('settlement');?>">结算</a>  -->
        </div>
    </div><?php endif; ?>
