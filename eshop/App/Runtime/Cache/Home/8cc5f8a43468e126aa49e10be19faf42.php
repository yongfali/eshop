          ...
          <ul class="p_list">
            <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li>
                <div class="list-wrap">
                  ...
                  <div class="p_name"> 
                    <a href="<?php echo U('Home/Index/goodsInfo',array('id'=>$item['goodid']));?>" target="_blank"><?php echo ($item["goodname"]); ?>
                    </a> 
                  </div>
                  ...
                  <div class="p_operate">
                    <a href="javascript:void(0)" onclick="cancle(<?php echo ($item["goodid"]); ?>,0,<?php echo (session('uid')); ?>)">
