...
<div class="ucenter_left">
  ...
  <div class="ucenter_right">
    <div class="ucenter_right_title"> <span>账号安全</span> </div>
    <div class="ucenter_right_content">
      <div class="security_head">
        <div class="left">
          <?php if(empty($info["photo"])): ?><img src="/eshop/Public/Home/Icon/no-img.png">
            <?php else: ?>
            <img src="/eshop/<?php echo ($info["photo"]); ?>"><?php endif; ?>
        </div>
        <div class="right">
          <div class="lists">
      ...
      <div class="security_content">
        <div class="setting">
          ...
          <a href="<?php echo U('Home/UserCenter/modifyPwd');?>" class="set-action">修改密码</a>
        </div>
        <div class="setting">
          ...
          <a href="javascript:void(0);" onclick="bindEmail('<?php echo ($info["email"]); ?>','unbind');">解绑邮箱</a>
          <?php else: ?>
          <span class="set-icon">
          ...
          <span class="set-name">邮箱验证</span>
          <span class="set-info">邮箱验证方便您及时接收优惠促销信息，以及积分、优惠卷和账户余额变动的提醒。</span>
          <a href="javascript:void(0);" onclick="bindEmail('<?php echo ($info["email"]); ?>','bind');">邮箱验证</a><?php endif; ?>
        </div>
        <div class="setting">
