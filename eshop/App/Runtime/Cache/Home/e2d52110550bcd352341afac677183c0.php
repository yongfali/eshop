...
<script src="/eshop/Public/Home/Js/shoperLog.js"></script>
<script type="text/javascript">
  var delLogInfo = "<?php echo U('delLog');?>";
</script>
</head>
<body>
<!-- 店铺首页头部开始 -->
...
<div class="scenter_left">
  ...
  <div class="scenter_right">
    <div class="scenter_right_title"> <span>操作记录</span> </div>
