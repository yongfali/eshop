...
<script src="/eshop/Public/Home/Js/User/userLogin.js"></script>
<script type="text/javascript">
  var checkVerify = "<?php echo U('checkVerify');?>";
  var doUserLogin = "<?php echo U('doLogin');?>";
...
<div class="login_conten">
  ...
  <div class="login_content_right">
    <form  method="post" id="userlogin">
      <span class="login_user">用户登录</span>
      <table class="tb">
        <tbody>
          <tr>
            <td><img src="/eshop/Public/Home/Image/login_img.png"></td>
            <td><input class="inputs" type="text" name="account" id="account " placeholder="用户名/邮箱/手机号" ></td>
          </tr>
          <tr>
            <td><img src="/eshop/Public/Home/Image/login_pwd.png"></td>
            <td><input class="inputs" type="password" name="pwd" id="pwd" placeholder="请输入密码" /></td>
          </tr>
          <tr>
            <td><img src="/eshop/Public/Home/Image/login_verify.png"></td>
            <td><div class="verify">
                <input type="text" name="verify1" id="verify1" placeholder="请输入右侧验证码">
                <img src="<?php echo U('verify');?>" id="verify-img" onclick = "changeVerify()"/> </div></td>
          </tr>
          <tr>
            <td colspan="2" style="padding-left:48px;"><input type="checkbox" name="auto" id="auto" checked="checked" value="1">
              <label>&nbsp;&nbsp;自动登录&nbsp;&nbsp;</label>
          ...
          <tr>
            <td colspan="2"><input type="submit" class=" inputs btn" id="login_btn" value="登录">
              <label><a href="<?php echo U('Home/ForgetPwd/index',array('type' => 'user'));?>">忘记密码 ?</a></label>
              <span>&nbsp;|&nbsp;</span>
              <label><a href="<?php echo U('regist');?>">免费注册</a></label></td>
          </tr>
        </tbody>
      </table>
    </form>
    <div class="other_login"> <span>您还可以使用以下方式进行登录：</span> <a href="<?php echo U('Home/Login/login?type=qq');?>" title="QQ"><img src="/eshop/Public/Home/Image/qq.png"></a> <a href="#" title="新浪"><img src="/eshop/Public/Home/Image/sina.png"></a> <a href="#" title="淘宝"><img src="/eshop/Public/Home/Image/taobao.png"></a> </div>
  </div>
</div>
<!-- 尾部开始 -->
<div class="float_clear"></div>
