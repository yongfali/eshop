...
<!-- 公共链接 -->
<script src="/eshop/Public/Home/Js/Shoper/modifyPwd.js"></script>
</head>
<body>
<!-- header开始 --> 
<!-- 店铺首页头部开始 -->
...
<div class="scenter_left">
  ...
  <div class="scenter_right">
    ...
    <div class="scenter_right_content">
      <form method="post" autocomplete="off" id="smodifypwd_form" rel="<?php echo U('doModifyPwd');?>">
