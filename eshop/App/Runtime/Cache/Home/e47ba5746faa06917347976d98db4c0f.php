...
<div class="ucenter_left">
  ...
  <div class="<?php if($_SESSION['type']== 1): ?>scenter_right<?php else: ?>ucenter_right<?php endif; ?>">
    <div class="<?php if($_SESSION['type']== 1): ?>scenter_right_title<?php else: ?>ucenter_right_title<?php endif; ?>"> <span>详细内容</span> </div>
    <div class="msg-detail">
    	<span><?php echo ($msgInfo["content"]); ?></span>
      <span style="display:block;">发送时间：<?php echo (date("Y-m-d H：m",$msgInfo["sendtime"])); ?></span>
    </div>
  </div>
  <!-- 右侧内容显示结束 --> 
</div>
