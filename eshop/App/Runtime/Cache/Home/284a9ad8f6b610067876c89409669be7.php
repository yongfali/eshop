...
<div class="ucenter_left">
  ...
  <div class="ucenter_right">
    <div class="ucenter_right_title"> <span>拒收或退款订单</span> 
    </div>
    <div class="ucenter_right_orders"> 
      ...
      <form action=" " id="order_search">
        <div class="order_search">
          ...
          <input type="button" value="查询"  class="btn" id="order_select" types="refund"/>
        </div>
      </form>
      <!-- 头部检索框 -->  
      <!-- 待付款订单内容展示 -->
              ...
              <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tbody class="orders_items">
                  <tr class="orders_head">
                    <td colspan="6">
                      <div class="order_time">
                        ...
                        <span>拒收时间：<?php echo (date("Y-m-d  H：i：s",$item["rejecttime"])); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <div class="order_status">已拒收</div>
                    </td>
                  </tr>
                  <tr class="orders_info">
                    ...
                    <td class="orders_action">
                     ...
                     <a href="<?php echo U('Home/UserOrders/complaintDetail',array('orderId' =>$item['orderid'],'goodId'=> $item['goodid']));?>">订单投诉</a>
                    </td>
                  </tr>
