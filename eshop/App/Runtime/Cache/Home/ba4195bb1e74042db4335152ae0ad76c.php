...
<script type="text/javascript">
  var paymentIndex = "<?php echo U('Home/ShoppingCart/payment');?>";
</script>
</head>
<body>
<!-- 头部header开始 -->
...
<div class="ucenter_left">
  ...
  <div class="ucenter_right">
    <div class="ucenter_right_title"> <span>待付款订单</span> 
    </div>
    <div class="ucenter_right_orders"> 
      ...
      <form action=" " id="order_search">
        <div class="order_search">
          ...
          <input type="button" value="查询"  class="btn" id="order_select" types="waitPay"/>
        </div>
      </form>
      <!-- 头部检索框 -->  
      <!-- 待付款订单内容展示 -->
              ...
              <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tbody class="orders_items">
                  <tr class="orders_head">
                    <td colspan="6">
                      ...
                      <div class="order_status">等待支付</div>
                    </td>
                  </tr>
