...
<div class="scenter_left">
  ...
  <div class="scenter_right">
    <div class="scenter_right_title"> <span>仓库中的商品</span> </div>
    <div class="scenter_right_content"> 
      ...
      <form action="<?php echo U('goodsSearch');?>" id="Good_Search">
        <div class="auth_good_search">
          ...
          <input type="button" value="查询"  class="btn" id="goods_select" types="store"/>
        </div>
      </form>
      <!-- 头部检索框 -->  
      <!-- 仓库中商品内容展示 -->
      <div class="auth_good_list">
        <div class="action_menu"> 
          <a href="javascript:offShelf(1);"class="s-sale"><span>上架</span></a> 
