...
<div class="ucenter_left">
  ...
  <ul>
    ...
    </a> <a href="<?php echo U('Home/UserOrders/waitReceive');?>">
    <li>待收货订单<span class="order-num"><?php echo ($waitReceiveNum); ?></li>
    </a> <a href="<?php echo U('Home/UserOrders/waitAppraise');?>">
  ...
  <div class="ucenter_right">
    <div class="ucenter_right_title"> <span>待评价订单</span> 
    </div>
        ...
        <div id="Orders_List_Contetn">
          <table class="orders_table">
            ...
            <?php if(empty($lists)): ?><tbody>
                <tr style="line-height:36px;text-align:center; color:red;"><td colspan="6">暂没有待评价订单！！！</td></tr>
              </tbody>
              <?php else: ?>
              <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tbody class="orders_items">
                  <tr class="orders_head">
                    <td colspan="6">
                      <div class="order_time">
                        ...
                        <span>收货时间：<?php echo (date("Y-m-d  H：i：s",$item["confirmtime"])); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <tr class="orders_info">
                    ...
                    <td class="orders_action">
                      ...
                      <a href="javascript:orderDel(<?php echo ($item["orderid"]); ?>)">订单删除</a>
                      <a href="#">订单投诉</a>
                   </td>
                 </tr>
