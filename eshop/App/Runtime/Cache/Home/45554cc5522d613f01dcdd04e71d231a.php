...
<div class="scenter_left">
  ...
  <div class="scenter_right">
    <div class="scenter_right_title"> <span>商家信息</span> </div>
        ...
        <table class="shopInfo_table">
          <tbody>
            ...
            <tr>
              ...
              <td><span class="content"><?php echo get_number($info['id']);?></span></td>
            </tr>
            <tr>
              <td class="itemsName">真实姓名：</td>
              <td><span class="content"><?php echo ($info["truename"]); ?></span></td>
            </tr>
            <tr>
              <td class="itemsName">商家性别：</td>
              <td><span class="content"><?php echo ($info["sex"]); ?></span></td>
            </tr>
            <tr>
              <td class="itemsName">身份证号：</td>
              <td><span class="content"><?php echo ($info["carnum"]); ?></span></td>
            </tr>
            <tr>
              <td class="itemsName">个人头像：</td>
              <td>
                <?php if(empty($info["face"])): ?><img src="/eshop/Public/Home/Icon/no-img.png">
                  <?php else: ?>
                  <img src="/eshop/<?php echo ($info["face"]); ?>"><?php endif; ?>
              </td>
            </tr>
            <tr>
              <td class="itemsName">个人QQ：</td>
              <td><span class="content"><?php echo ($info["qq"]); ?></span></td>
            </tr>
            <tr>
              <td class="itemsName">联系方式：</td>
              <td><span class="content"><?php echo ($info["tel"]); ?></span></td>
            </tr>
            <tr>
              <td class="itemsName">商家状态：</td>
              <td><span class="content">审核通过</span></td>
            </tr>
            <tr>
              <td colspan="2" style="text-align:center;">
                <span style="color:#f60;">（注：商家基本信息修改需要联系&nbsp;&nbsp;<a href="#">网站管理员</a>&nbsp;&nbsp;进行审核方可开放权限进行修改！）</span>
              </td>
            </tr>
          </tbody>
        </table>
