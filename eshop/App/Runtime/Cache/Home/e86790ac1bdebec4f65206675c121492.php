...
<div class="forgetPwd_wrap">
	...
	<div class="forget-pwd">
		<div style="height:120px;line-height:120px;text-align:center;">
			<img src="/eshop/Public/Home/Icon/modifyPwdSuccess.png" style="width:25px;height:25px;vertical-align: middle;">
			<span style="padding:0px 10px;">密码修改成功！</span>
			<span>
				<?php switch($utype): case "shoper": ?><a href="<?php echo U('Home/Shoper/index');?>">立即登录</a><?php break;?>
					<?php default: ?>
					<a href="<?php echo U('Home/User/Login');?>">立即登录</a><?php endswitch;?>
			</span>
		</div>
	</div>
</div>
