...
<link rel="stylesheet" type="text/css" href="/eshop/Public/Home/Css/login.css">
<script src="/eshop/Public/Home/Js/shoperLogin.js"></script>
<script>
  var checkVerify = "<?php echo U('checkVerify');?>";
  var doShoperLogin = "<?php echo U('doLogin');?>";
  var index = "<?php echo U('Home/ShopCart/index');?>";
</script>
</head>
<body>
<!-- 头部header开始 -->
...
<div class="login_content_left"> <img src="/eshop/Public/Home/Image/login_left.jpg"> </div>
<div class="login_content_right">
  <form action="#" method="post" id="shoperLogin">
    <span class="login_user">商户登录</span>
    <table class="tb">
      <tbody>
        <tr>
          <td><img src="/eshop/Public/Home/Image/login_img.png"></td>
          <td><input class="inputs" type="text" name="shopername" id="shopername" placeholder="商户名/邮箱/手机号"></td>
        </tr>
        <tr>
          <td><img src="/eshop/Public/Home/Image/login_pwd.png"></td>
          <td><input class="inputs" type="password" name="shoper_pwd" id="shoper_pwd" placeholder="请输入密码" /></td>
        </tr>
        <tr>
          <td><img src="/eshop/Public/Home/Image/login_verify.png"></td>
          <td><div class="verify">
              <input type="text" name="verify1" id="verify1" placeholder="请输入右侧验证码"/>
              <img src="<?php echo U('verify');?>" id="s_loginImg" onClick="changeVerify();"> </div></td>
        </tr>
        <tr>
          <td colspan="2" style="padding-left:48px;"><input type="checkbox" name="auto" id="auto" checked="checked" value="1" checked="checked">
            <label>&nbsp;&nbsp;自动登录&nbsp;&nbsp;</label>
            <label>看不清？&nbsp; <a href="javascript:changeVerify();">换一张</a> </label></td>
        </tr>
        <tr>
          <td colspan="2"><input type="submit" class="inputs btn" id="login_btn" value="登录">
            <label><a href="<?php echo U('Home/ForgetPwd/index',array('type' => 'shoper'));?>">忘记密码 ?</a></label>
            <span>&nbsp;|&nbsp;</span>
            <label><a href="<?php echo U('regist');?>">我要开店</a></label></td>
        </tr>
      </tbody>
    </table>
  </form>
  <div class="other_login"> <span>您还可以使用以下方式进行登录：</span> <a href="#" title="QQ"><img src="/eshop/Public/Home/Image/qq.png"></a> <a href="#" title="新浪"><img src="/eshop/Public/Home/Image/sina.png"></a> <a href="#" title="淘宝"><img src="/eshop/Public/Home/Image/taobao.png"></a> </div>
</div>
<!-- 尾部开始 -->
<div class="float_clear"></div>
<div class="footer">
